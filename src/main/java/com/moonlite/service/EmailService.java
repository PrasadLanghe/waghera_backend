...
public class EmailService {
    ...
    public void sendRegistrationEmail(String toEmail, String userName) {
        ...
        try {
            ...
            helper.setSubject("🎉 Welcome to Waghera Agro Tourism – Registration Successful!");

            String htmlMsg = """
                    <div style="font-family: Arial, sans-serif; padding: 20px; background-color: #f4f4f4;">
                        <div style="max-width: 600px; margin: auto; background: white; border-radius: 10px; padding: 20px;">
                            
                            <h2 style="color: #2c7a7b; text-align:center;">🌿 Welcome to Waghera Agro Tourism 🌿</h2>
                            ...
                            <p>
                                ...
                                <b>Instagram:</b> <a href="https://instagram.com/wagheraagro" style="color:#3182ce;">@wagheraagro</a>
                            </p>
